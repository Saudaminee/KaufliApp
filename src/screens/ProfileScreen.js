...
import { View, Text, FlatList, Image,TouchableOpacity, SafeAreaView ,ImageBackground,StatusBar,ScrollView} from 'react-native';
...
const ProfileScreen = () => {
  ...
  return (
    <SafeAreaView >
     ...
     <ProfileHeader name="Hello!!  John doe" mobile="1234567890" email="johndoe@gmail.com" />
     <ScrollView  style={{backgroundColor:colors.WHITE,borderTopLeftRadius:15,borderTopRightRadius:15,marginTop:10,paddingBottom:'10%'}}>
     <View >

     <Text style={[styles.profileText,{fontSize:12,fontWeight:'bold',paddingHorizontal:'5%',paddingTop:10}]} >My Payments </Text>
     ...
     <Text style={[styles.profileText,{fontSize:12,fontWeight:'bold',paddingHorizontal:'5%',paddingTop:'5%'}]} >Others </Text>
